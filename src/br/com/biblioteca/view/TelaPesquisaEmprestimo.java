 ...
 * @author rf
 */
public class TelaPesquisaEmprestimo extends javax.swing.JDialog {

    /**
     * Creates new form TelaPesquisaEmprestimo
     */
    private Frame parent; 
    public TelaPesquisaEmprestimo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.parent = parent;
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Pesquisar Empréstimo");
        ...
        comboBoxBusca.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Matricula", "Nome do Aluno", "Titulo do Livro", "Data de Empréstimo", "Com Renovação" }));
        ...
        tabelaListaEmprestimo.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Matricula", "Nome do Aluno", "Titulo do Livro", "Data de Empréstimo", "Renovado"
            }
        ) {
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, kGradientPanel1Layout.createSequentialGroup()
                ...
                .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(kGradientPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(btnRenovarEmprestimo, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGap(18, 18, 18)
                        .addComponent(btnRealizarDevolucao, javax.swing.GroupLayout.PREFERRED_SIZE, 251, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(btnExcluir, javax.swing.GroupLayout.PREFERRED_SIZE, 235, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(30, 30, 30))
        );
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        int linhaSelecionada = tabelaListaEmprestimo.getSelectedRow();
        if(linhaSelecionada == -1){
            JOptionPane.showMessageDialog(this, "Nenhum Empréstimo Selecionado", "Falha na Exclusão", JOptionPane.WARNING_MESSAGE);
            return;
        }
        Emprestimo emprestimo = new Emprestimo();
        Aluno aluno = new Aluno();
        ...
        int decisaoDeExcluir = 0;
          try{
              ...
              int id_Emprestimo = Integer.parseInt(id);
              emprestimo = emprestimos.getEmprestimoID(id_Emprestimo);
              decisaoDeExcluir = JOptionPane.showOptionDialog(this, "Deseja Realmente Excluir o Empréstimo ", "Decisão de Exclusão", JOptionPane.YES_OPTION, JOptionPane.NO_OPTION, null, null, null);
                if(decisaoDeExcluir == 0){
                    ...
                    JOptionPane.showMessageDialog(this, "Empréstimo Excluido", "Exclusão Efetuada", JOptionPane.INFORMATION_MESSAGE);
                }
    ...
    public void inserirLinhaTabela(Emprestimo emprestimo, DefaultTableModel tabela){
        ...
        tabela.addRow(new String[] {String.valueOf(emprestimo.getId()) ,String.valueOf(emprestimo.getAluno().getMatricula()), emprestimo.getAluno().getNome(), emprestimo.getLivro().getTitulo(), dataEmprestimo, renovado});
    }
    ...
    private void buscarEmprestimo(boolean buscar){
        ...
        for(int i = 0; i < emprestimos.quantidadeEmprestimo(); i++){
            ...
            if(!emprestimo.isEmprestimoTerminado()){
                if(cbxIndex == 0){
                    matricula = String.valueOf(emprestimo.getAluno().getMatricula());
                    if(matricula.contains(txtDeBusca))
                        inserirLinhaTabela(emprestimo, tabela);
                }else if(cbxIndex == 1){
                    nomeAluno = emprestimo.getAluno().getNome();
                    if(nomeAluno.toLowerCase().contains(txtDeBusca))
                        inserirLinhaTabela(emprestimo, tabela);
                }else if(cbxIndex == 2){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaPesquisaEmprestimo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaPesquisaEmprestimo dialog = new TelaPesquisaEmprestimo(new javax.swing.JFrame(), true);
